...
- **[Manifest Generation Log](/DuckDeploy/compliance/manifest-generation-log.json)**: The mapping between components and API paths.
- **[Contract Validation Report](/DuckDeploy/compliance/contract-validation-report.json)**: The results of statically verifying the UI mapping against the OpenAPI contract constraints.
- **[Test Results (JUnit)](/DuckDeploy/compliance/junit.xml)**: The results of test runs mapped to requirements.
- **[Traceability Matrix](/DuckDeploy/compliance/traceability-matrix.json)**: The resulting ISO 29148 compliance matrix containing all traces and integrity hashes.
