...
<!-- COMPONENT_UI_ENGINE_START -->
### UI Engine

<!-- COMPONENT_UI_ENGINE_METADATA_START -->
**Role**: Dynamic UI Rendering
**Version**: 1.0.0
<!-- COMPONENT_UI_ENGINE_METADATA_END -->

<!-- COMPONENT_UI_ENGINE_DESCRIPTION_START -->
The UI Engine dynamically renders standard React-Admin `<Resource>` definitions and handles form layout mapping based on the OpenAPI definitions.
<!-- COMPONENT_UI_ENGINE_DESCRIPTION_END -->
<!-- COMPONENT_UI_ENGINE_END -->

<!-- COMPONENT_API_CLIENT_START -->
### API Client Generation

<!-- COMPONENT_API_CLIENT_METADATA_START -->
**Role**: Code Generation
**Version**: 1.0.0
<!-- COMPONENT_API_CLIENT_METADATA_END -->

<!-- COMPONENT_API_CLIENT_DESCRIPTION_START -->
API Client Generation leverages Orval to generate strictly typed Axios fetchers and data models from the OpenAPI specification at build time.
<!-- COMPONENT_API_CLIENT_DESCRIPTION_END -->
<!-- COMPONENT_API_CLIENT_END -->
